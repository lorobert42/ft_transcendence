...
"""
        ...
        Todo:
        - add reward based on the center of the paddle
        - check creating a bot without RL, calculate where the ball will land and move the paddle there
        - check the observation % 2 == 0, if it is, update the observation, otherwise, take the last action
"""
...
'''
def main():
    agent_left = load_model('v0_left_agent.h5')
    agent_right = load_model('v0_right_agent.h5')
